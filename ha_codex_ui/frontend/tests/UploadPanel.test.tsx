...
it("validates upload file size", async () => {
  ...
  render(<UploadPanel currentPath="." selectedWorkspace={{ id: "share-workspace", name: "Workspace", root: "/share/ha_codex_ui_workspace", readable: true, writable: true, sensitive: false }} />);
