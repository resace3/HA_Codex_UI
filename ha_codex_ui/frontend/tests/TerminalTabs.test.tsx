...
it("renders and closes terminal tabs", async () => {
  ...
  render(
    <TerminalTabs
      terminals={[{ id: "1", name: "Shell", type: "shell", workspaceId: "share-workspace", cwd: "/share/ha_codex_ui_workspace", createdAt: "2026-01-01T00:00:00.000Z", lastActiveAt: "2026-01-01T00:00:00.000Z", status: "running", cols: 120, rows: 30 }]}
      activeTerminalId="1"
